<?php
/**
 * This is a template part for displaying the nav area with the logo navigation
 * on the same line
 *
...
<div class="usa-navbar nav-float-logo">
...
<nav role="navigation" class="usa-nav nav-float-nav">
